...
<script>
  ...
  import GithubService from './repository/GithubRepository';
  ...
  export default {
      ...
      fetchRepositories() {
        ...
        this.repositories.forEach(repository => {
          this.githubService.listIssues(repository)
            ...
            .then(issues => {
              this.blocks = issues.concat(this.blocks)
            });
        });
      },
    ...
    created() {
      ...
      this.githubService = new GithubService(config.github.accessToken);
